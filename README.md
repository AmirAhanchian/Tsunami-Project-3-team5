...
Datasets link:  https://www.kaggle.com/datasets/ramjasmaurya/historical-data-of-tsunamis18002021

Data Type (surveys, financial dataset, etc.): Global data for tsunamis. 

# Visualizations: 3-layered interactive map (death counts, tectonic plate overlay, tsunami intensity), interactive bar charts (tsunami count by country, number of tsunamis between 1920s to early 200s, and Tsunami Causes).  
